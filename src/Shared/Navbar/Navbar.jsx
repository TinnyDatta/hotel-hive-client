...
const Navbar = () => {
  const {user, logout} = useContext(AuthContext)
    ...
    <li><NavLink className={({isActive}) => isActive? ' border p-2 border-purple-400 text-purple-500' : ''} to='/allTouristsSpot'>Rooms</NavLink></li> 
    {
      user && <>
      <li><NavLink className={({isActive}) => isActive? ' border p-2 border-purple-400 text-purple-500' : ''} to='/addTouristsSpot'>My Bookings</NavLink></li>
      </>
    }
  ...
  <div className="navbar-start">
    ...
    <a  className="btn btn-ghost text-2xl font-bold text-red-300 bg-purple-100">HotelHive</a>
